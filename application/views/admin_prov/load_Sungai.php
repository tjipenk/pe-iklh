										...
										<?php if (count($sungai)>0): ?>
                                            <?php foreach($sungai as $pub): ?>
                                                <tr data-id="<?php echo $pub['id']; ?>">
                                                    <td><a style="cursor:pointer;" class="removerutilizador" onclick="delete_sungai(<?=$pub['id']?>)"><span class="label label-danger">Hapus</span></a></td>
                                                    <td><a style="cursor:pointer;" class="editstory" href="<?php echo base_url(); ?>admin_prov/editsungai/<?php echo $pub['id']; ?>"><span class="label label-warning">Edit</span></a></td>
